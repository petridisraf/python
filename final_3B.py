...
tags_by_group = {
    'Κένταυροι': [
        'Κένταυροι', 'Κένταυροι-Μέση Κενταύρων και πάνω-Δεξής Κένταυρος', 'Κένταυροι-Μέση Κενταύρων και κάτω-Δεξής Κένταυρος',
        'Κένταυροι-Μέση Κενταύρων και πάνω-Αριστερός Κένταυρος', 'Κένταυροι-Μέση Κενταύρων και κάτω-Αριστερός Κένταυρος',
        'Κένταυροι-Μεση Κενταύρων και πάνω-Δεξής Κένταυρος', 'Κένταυροι-Μεση Κενταύρων και κάτω-Δεξής Κένταυρος',
        'Κένταυροι-Μεση Κενταύρων και πάνω-Αριστερός Κένταυρος', 'Κένταυροι-Μεση Κενταύρων και κάτω-Αριστερός Κένταυρος',
        'Κένταυροι-Μεση Κενταύρων και κάτω-Αριστερός Κένταυρος', 'Δεξής Κένταυρος-Αριστερός Κένταυρος', 'Δεξής Κένταυρος',
        'Αριστερός Κένταυρος', 'Μέση Κενταύρων και πάνω', 'Μεση Κενταύρων και κάτω','Κένταυροι-Μεση Κενταύρων και κάτω-Αριστερός Κένταύρος'
    ],
    'Απόλλωνας': [
        'Απόλλωνας', 'Δεξί χέρι Απόλλωνα', 'Κεφάλι Απόλλωνα', 'Απόλλωνας-Δεξί χέρι Απόλλωνα', 'Απόλλωνας-Κεφάλι Απόλλωνα'
    ],
    'Γυναίκες': ['Αριστερή γυναίκα', 'Δεξιά γυναίκα', 'Αριστερή γυναίκα-Δεξιά γυναίκα','Λαπίθες'],
    'Άνδρες': ['Δεξιά άνδρας-Βασιλιάς Λαπιθών', 'Αριστερά άνδρας', 'Δεξιά άνδρας-Βασιλιάς Λαπιθών -Αριστερά άνδρας'],
    'Ναός': ['Αέτωμα/στέγη ναού']
}
...
output_file = 'comparison_results_by_team_3B.txt'
